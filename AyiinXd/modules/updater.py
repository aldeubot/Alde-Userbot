...
async def upstream(event):
    ...
    off_repo = b64decode(
        "aHR0cHM6Ly9naXRodWIuY29tL2FsZGV1Ym90L0FsZGUtVXNlcmJvdA=="
    ).decode("utf-8")
    force_update = False
    try:
...
CMD_HELP.update(
    {
        ...
        \n\n  »  **Perintah :** `{cmd}update`\
        \n  »  **Kegunaan : **Untuk Melihat Pembaruan Terbaru Alde-Userbot.\
        \n\n  »  **Perintah :** `{cmd}update deploy`\
        \n  »  **Kegunaan : **Untuk MengUpdate Fitur Terbaru Dari Alde-Userbot.\
    "
    }
)
